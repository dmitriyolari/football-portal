...
<div class="wrapper container px-4">
    ...
    <div class="border">
        ...
        <main class="row">
            ...
            <div class="content col-7 pt-3">
                @yield('content_main-articles')
                @yield('personal-area-header')
                @yield('personal_area-body')
            </div>
            <aside class="latest-news col-3 pt-3">
                <h5>Новости</h5>
                <ul>
                    <li>
                        <a href="#">Деле Алли: "Поражение от "Челси" - несправедливый результат".</a>
                        <div class="date">19.09.2021 22:29:54</div>
                    </li>
                    <li>
                        <a href="#">Чемпионат Германии. "Вольфсбург" и "Айнтрахт" не выявили победителя.</a>
                        <div class="date">19.09.2021 22:26:24</div>
                    </li>
                    <li>
                        <a href="#">Нуну Эшпириту Санту: "Это была игра с двумя разными таймами".</a>
                        <div class="date">19.09.2021 22:18:52</div>
                    </li>
                    <li>
                        <a href="#">Евгений Калешин: "Мы показали качественный футбол".</a>
                        <div class="date">19.09.2021 22:11:51</div>
                    </li>
                    <li>
                        <a href="#">Чемпионат MLS. "Монреаль" оказался сильнее "Чикаго Файр".</a>
                        <div class="date">19.09.2021 22:10:14</div>
                    </li>
                    <li>
                        <a href="#">Страх и ненависть в Амстердаме. Обзор 5-го тура чемпионата Нидерландов.</a>
                        <div class="date">19.09.2021 22:09:45</div>
                    </li>
                </ul>
            </aside>
        </main>
